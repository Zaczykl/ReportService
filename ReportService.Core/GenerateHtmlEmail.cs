    ...
    public class GenerateHtmlEmail
    {
        public string GenerateErrors(List<Error> errors, int interval)
        {
            ...
            html += @"
                <table border=1 cellpadding=5 cellspacing=1>
                    <tr>
                        <td align=center bdcolor=lightgrey>Wiadomość</td>
                        <td align=center bdcolor=lightgrey>Data</td>
                    </tr>
                    ";
                ...
                html +=
                    $@"
                        <tr>
                            ...
                            <td align=center>{error.Date.ToString("dd-MM-yyyy HH:mm:ss")}</td>
                        </tr>
        ...
        public string GenerateReport(Report report)
        {
            ...
            if (report.Positions.Any() && report.Positions != null)
            {
                ...
                <table border=1 cellpadding=5 cellspacing=1>
                    <tr>
                        <td align=center bdcolor=lightgrey>Tytuł</td>
                        <td align=center bdcolor=lightgrey>Opis</td>
                        <td align=center bdcolor=lightgrey>Wartość</td>
                    </tr>
                    ";
